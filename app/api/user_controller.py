...
def get_user(
    ...
    try:
        ...
        print("Enter get_user method again change done3333")
        print("Enter get_user method again change done4444")
        print("Enter get_user method again change done5555")
        print("Enter get_user method again change done6666")
